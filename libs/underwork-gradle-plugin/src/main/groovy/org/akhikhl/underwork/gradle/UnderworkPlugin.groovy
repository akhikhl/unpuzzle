...
import org.akhikhl.underwork.eclipse2maven.EclipseDownloader
import org.akhikhl.underwork.eclipse2maven.EclipseDeployer
import org.akhikhl.underwork.eclipse2maven.EclipseSource
import org.akhikhl.underwork.osgi2maven.Deployer

/**
 * Gradle plugin for mavenizing eclipse
 */
class UnderworkPlugin implements Plugin<Project> {

  void apply(Project project) {

    project.extensions.create('underwork', UnderworkPluginExtension)
    ...
    project.afterEvaluate {
      ...
      project.task('downloadEclipse') {
        ...
        doLast {
          if(!project.underwork.sources)
            applyDefaultConfig(project)
          project.buildDir.mkdirs()
          new EclipseDownloader().downloadAndUnpack(project.underwork.sources, project.buildDir)
      ...
      project.task('installEclipse') {
        ...
        doLast {
          ...
          new EclipseDeployer(project.underwork.group).deploy(project.underwork.sources, project.buildDir, mavenDeployer)
      ...
      project.task('uploadEclipse') {
        ...
        doLast {
          def uploadEclipse
          if(project.underwork.uploadEclipse)
            uploadEclipse = project.underwork.uploadEclipse
          ...
          if(!uploadEclipse || !uploadEclipse.url || !uploadEclipse.user || !uploadEclipse.password) {
            ...
            System.err.println 'See Underwork online documentation for more details:'
            System.err.println 'https://github.com/akhikhl/underwork/blob/master/README.md'
            return
          }
